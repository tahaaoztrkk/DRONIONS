...
def draw_overlay(frame: np.ndarray, candidates: List[DetectionCandidate], nav_decision: Dict[str, Any] = None) -> np.ndarray:
    """
    ...
    for cand in candidates:
        ...
        color = (0, 255, 0) if cand.gemini_verified and cand.verified else (0, 165, 255)
